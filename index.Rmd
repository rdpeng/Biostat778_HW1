...
1.  **Fork** the
[Biostat778_HW1](https://github.com/rdpeng/Biostat778_HW1) repository
on GitHub

2.  Once you have cloned the repository on GitHub, you can **clone**
...
6.  If you want me to time your functions on the test code, you can
send me a pull request and I will run it on my computer. Timings that
are run on my computer will go on the leaderboard maintained in the
Git repository for the homework.

7.  Your finished code should be submitted in the form of an **R
package**. The R package should be named **Homework1**.
